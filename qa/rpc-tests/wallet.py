...
#   c) node1 mines 32 blocks, so now node 0 has 60001mcc, node 1 has 4250mcc, node2 has none.
#   d) node0 sends 601 mcc to node2, in two transactions (301 mcc, then 300 mcc).
