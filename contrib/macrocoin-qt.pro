...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/macrocoin-cli.cpp \
           src/macrocoin-tx.cpp \
           src/macrocoin.cpp \
           src/db.cpp \
           ...
           src/qt/macrocoin.cpp \
           src/qt/macrocoinstrings.cpp \
...
RESOURCES += src/qt/macrocoin.qrc src/qt/macrocoin_locale.qrc

TRANSLATIONS += src/qt/locale/macrocoin_bg.ts \
                src/qt/locale/macrocoin_de.ts \
                src/qt/locale/macrocoin_en.ts \
                src/qt/locale/macrocoin_es.ts \
                src/qt/locale/macrocoin_fi.ts \
                src/qt/locale/macrocoin_fr.ts \
                src/qt/locale/macrocoin_it.ts \
                src/qt/locale/macrocoin_ja.ts \
                src/qt/locale/macrocoin_pl.ts \
                src/qt/locale/macrocoin_pt.ts \
                src/qt/locale/macrocoin_ru.ts \
                src/qt/locale/macrocoin_sk.ts \
                src/qt/locale/macrocoin_sv.ts \
                src/qt/locale/macrocoin_vi.ts \
                src/qt/locale/macrocoin_zh_CN.ts \
                src/qt/locale/macrocoin_zh_TW.ts
