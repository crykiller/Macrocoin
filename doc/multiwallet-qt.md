...
In order to support loading of multiple wallets in macrocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is macrocoin.cpp.
...
Changes to macrocoin.cpp
----------------------
macrocoin.cpp is the entry point into macrocoin-qt, and as such, will require some minor modifications to provide hooks for
