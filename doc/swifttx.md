...
This mechanism has been integrated into Bitcore-Node-Macrocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Macrocoin-Project/insight-api-macrocoin#web-socket-api](https://github.com/Macrocoin-Project/insight-api-macrocoin#web-socket-api) 
* API: [https://github.com/Macrocoin-Project/insight-api-macrocoin#swifttx-transactions](https://github.com/Macrocoin-Project/insight-api-macrocoin#swifttx-transactions) 
...
By default, the Macrocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Macrocoin Core daemon:
