...
#ifndef Macrocoin_STAKEINPUT_H
#define Macrocoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZMCC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zMCCStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zmcc, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZMCC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZMCC() override { return false; }
};


#endif //Macrocoin_STAKEINPUT_H
