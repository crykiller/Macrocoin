...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Macrocoin Core"),
     ...
     * override -datadir in the macrocoin.conf file in the default data directory
     * (to be consistent with macrocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
