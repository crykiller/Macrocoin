...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zmccTracker->HasMintTx(hash))) {
            //zMCC stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZMCC;
...
bool IsZMCCType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZMCC:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZMCC || type == TransactionRecord::MNReward) {
