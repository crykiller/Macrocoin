...
/** Utility functions used by the Macrocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Macrocoin addresses in monospace font
...
// Parse "macrocoin:" URI into recipient object, return true on successful parsing
