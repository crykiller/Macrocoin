                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMCCPathCustom = GetArg("-zmccbackuppath", "");
    ...
    if(!strzMCCPathCustom.empty()) {
        ui->wallet_customzmccbackuppath->setText(QString::fromStdString(strzMCCPathCustom));
        ui->wallet_customzmccbackuppath_label->setVisible(true);
        ui->wallet_customzmccbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMCCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Macrocoin RPC console.") + "<br>" +
