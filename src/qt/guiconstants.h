...
/* Macrocoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Macrocoin"
#define QAPP_ORG_DOMAIN "macrocoin.org"
#define QAPP_APP_NAME_DEFAULT "Macrocoin-Qt"
#define QAPP_APP_NAME_TESTNET "Macrocoin-Qt-testnet"
