                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Macrocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Macrocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and macrocoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMCC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Macrocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Macrocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Macrocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Macrocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Macrocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Macrocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Macrocoin Core help message to get a list with possible Macrocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Macrocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Macrocoin network", "", count));
}
...
{
    QString strTitle = tr("Macrocoin Core"); // default title
