...
/**
 * Macrocoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzmccseed(const UniValue& params, bool fHelp);
extern UniValue getzmccseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmcc(const UniValue& params, bool fHelp);
extern UniValue dzmccstate(const UniValue& params, bool fHelp);
