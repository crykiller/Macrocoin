/* src/config/macrocoin-config.h.  Generated from macrocoin-config.h.in by configure.  */
/* src/config/macrocoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.macrocoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Macrocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Macrocoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "macrocoin"
