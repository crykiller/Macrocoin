...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Macrocoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Macrocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Macrocoin features */
        {"macrocoin", "masternode", &masternode, true, true, false},
        {"macrocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"macrocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"macrocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"macrocoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"macrocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"macrocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"macrocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"macrocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"macrocoin", "startmasternode", &startmasternode, true, true, false},
        {"macrocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"macrocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"macrocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"macrocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"macrocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"macrocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"macrocoin", "mnbudget", &mnbudget, true, true, false},
        {"macrocoin", "preparebudget", &preparebudget, true, true, false},
        {"macrocoin", "submitbudget", &submitbudget, true, true, false},
        {"macrocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"macrocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"macrocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"macrocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"macrocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"macrocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"macrocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"macrocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"macrocoin", "mnsync", &mnsync, true, true, false},
        {"macrocoin", "spork", &spork, true, true, false},
        {"macrocoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmccseed", &getzmccseed, false, false, true},
        {"zerocoin", "setzmccseed", &setzmccseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmcc", &searchdzmcc, false, false, true},
        {"zerocoin", "dzmccstate", &dzmccstate, false, false, true}
...
{
    return "> macrocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6441/\n";
}
