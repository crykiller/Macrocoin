...
#ifndef Macrocoin_ZMCCWALLET_H
#define Macrocoin_ZMCCWALLET_H
...
public:
    CzMCCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMCC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMCC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Macrocoin_ZMCCWALLET_H
