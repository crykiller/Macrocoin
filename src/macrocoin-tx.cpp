...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Macrocoin Core macrocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  macrocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded macrocoin transaction") + "\n" +
                               "  macrocoin-tx [options] -create [commands]   " + _("Create hex-encoded macrocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded macrocoin transaction
