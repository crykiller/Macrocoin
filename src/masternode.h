...
#define MASTERNODE_MIN_CONFIRMATIONS 101
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 MCC, signature to prove
