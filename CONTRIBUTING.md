Contributing to Macrocoin Core
============================

The Macrocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Macrocoin Core project, and is not to be
confused with overall Macrocoin Network Protocol consensus changes.

Whether a pull request is merged into Macrocoin Core rests with the project merge
...
Patches that change Macrocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Macrocoin consensus, it must have been
...
The project leader is the release manager for each Macrocoin Core release.
